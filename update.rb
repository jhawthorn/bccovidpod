...
input_items = input.items.select do |input_item|
    ...
    title =~ /COVID-19 (Vaccine |BC |Immunization Plan )?Update|Immunization Plan|Surgical Renewal Strategy Update|Premier Horgan Update|Media Availability|plan to safely restart the province|AstraZenica/i
